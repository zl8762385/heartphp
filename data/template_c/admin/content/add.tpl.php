<?php if(!defined('IS_HEARTPHP')) exit('Access Denied');/*Create On##1381572265|Compiled from##D:/PHPnow/htdocs/heartphp/tpl/admin/content/add.html*/?>
...
<div class="col w10">
          <form id="form1" action="<?php echo get_url('admin', 'content', 'add') ?>" method="post" enctype="multipart/form-data">
            ...
            <p>
              <?php if(!empty($form_data)) { ?>
                  ...
                  <input class="button" type="submit" name="dosubmit" value="提交并继续发表" />
              <?php } ?>
